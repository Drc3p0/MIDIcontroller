...
// constructors
MIDIbuttonNoteChange::MIDIbuttonNoteChange() : Bounce(0, 0), Flicker(0, 0){};

//MIDIbutton::MIDIbutton(int p, byte num, byte mod) : Bounce(p, 10), Flicker(0, 0){
//MIDIbuttonNoteChange::MIDIbuttonNoteChange(int p, byte num, byte mod) : Bounce(p, 10), Flicker(0, 0){
